...
% TODO make figure on the left larger cannot read
	...
	% TODO do a graphic for the message that somewhat ressembles the other two
	\subsection{Parts}
...
\end{figure}
	...
	% TODO explain why I need a high amount of mAH
...
%TODO mark inside the listing the change/write a little bit smoother transition inbetween the inserted points
	...
	% TODO get the shitty third parameter that says which channels goe through
