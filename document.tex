...
\end{figure}
	...
	\end{lstlisting}
	% TODO what is this ???? it is fixed by setting it to ACM0 or serial0. Because different on rasppi ACM is for the USB and AMA shortened for AMBA is for the pins? \cite{ttyAMA}
