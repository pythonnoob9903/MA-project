...
\end{figure}
	...
	The RaspberryPi is not shipped with an microSD card and through that also not with the \ref{OS}. To download the \ref{OS}, the RaspberryPi Imager is used. Through the imager it is possible to create an account for the RaspberryPi,  configure the wifi and the possibility for the \ref{SSH} connection. 
